  ...
  try {
    ...
    const lead = await prisma.lead.findUnique({
      ...
      select: {
        ...
        // v3.3.14 — multi-service intake + research cards
        interestedServices: true,
        currentPhoneSystem: true,
        currentPhonePainPoint: true,
        currentAccessControl: true,
        currentAccessDoorCount: true,
        currentVideoSurveillance: true,
        currentVideoCameraCount: true,
        cablingStatus: true,
        expansionPlans: true,
        aiAdvisoryInterest: true,
        researchFitSignals: true,
        researchSuggestedQuestions: true,
        researchRisks: true,
      },
    });
    ...
    const result = await coachSale(
      {
        lead: {
          ...
          // v3.3.14 — pass intake + research cards through
          ...
          researchFitSignals: lead.researchFitSignals,
          researchSuggestedQuestions: lead.researchSuggestedQuestions,
          researchRisks: lead.researchRisks,
        },
